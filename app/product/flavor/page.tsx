                ...
                <div className="grid grid-cols-3 md:grid-cols-6 gap-3 md:gap-6 max-w-4xl mx-auto">
                  <div className="text-center">
                    <div className="w-10 h-10 md:w-12 md:h-12 mx-auto mb-2 flex items-center justify-center">
                      <svg
                        className="w-6 h-6 md:w-8 md:h-8 stroke-black stroke-2 fill-none"
                        viewBox="0 0 24 24"
                      >
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xs text-gray-600 leading-tight">Only 8g per can</p>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xs text-gray-600 leading-tight">Locally crafted</p>
                  </div>
