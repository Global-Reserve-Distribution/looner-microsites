...
function extractColorMetafields(product: any) {
  ...
  // Try both naming conventions (underscore and spaces/capitals)
  const primaryColorField = metafields.find(
    (field: any) => field && (field.key === "primary_color" || field.key === "Primary Color"),
  );
  const secondaryColorField = metafields.find(
    (field: any) => field && (field.key === "secondary_color" || field.key === "Secondary Color"),
  );
