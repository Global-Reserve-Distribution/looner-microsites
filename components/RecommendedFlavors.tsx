          ...
          return (
            ...
            >
              ...
              <div className="relative w-full px-3 transition-all duration-300 ease-linear">
                {/* Desktop Hover Layout - Hidden on mobile */}
                <div className="absolute inset-0 hidden lg:block opacity-0 group-hover:lg:opacity-100 transition-opacity duration-300">
                  {/* Top Section with Product Image */}
                  <div 
                    className="h-3/4 w-full relative overflow-hidden"
                  ...
                  <div className="bg-white h-1/4 w-full relative flex flex-col justify-center px-5 py-2">
                    <p className="font-display text-sm font-black leading-none text-gray-900 text-center mb-2">
                      {flavor.title.replace(/\s*-\s*\d+mg.*$/, "")}
                    </p>
                    
                    <p className="text-xs leading-normal text-gray-700 text-center mb-2">
              ...
              {/* Text Container */}
              <div className="row-span-1 row-start-2 h-full w-full p-3 lg:py-8 group-hover:lg:opacity-0" style={{ padding: '0px' }}>
                <div className="relative flex h-full w-full flex-col px-3 text-center transition-all duration-300 ease-in-out lg:top-7 lg:px-5">
                  <p className="pt-3 font-display text-sm font-black leading-none text-gray-900 md:pt-0 md:text-base">
                    {flavor.title.replace(/\s*-\s*\d+mg.*$/, "")}
                  </p>
                  
                  {/* Desktop rating - shown in default state */}
