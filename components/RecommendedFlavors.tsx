        ...
        {recommended.map((flavor, index) => {
          ...
          return (
            <div
              ...
              className="product-card relative group cursor-pointer focus:ring-2 grid h-full w-full overflow-hidden rounded-2xl aspect-[4/5]"
              style={{ 
                backgroundColor: secondary,
                gridTemplateRows: 'max-content 1fr'
              }}
            >
              {/* Desktop Hover Overlay - Only visible on desktop hover */}
              <div className="absolute inset-0 hidden lg:block opacity-0 group-hover:lg:opacity-100 transition-opacity duration-300 z-20 rounded-2xl overflow-hidden">
                ...
                >
                  ...
                  <div className="absolute inset-0">
                    <div 
                      ...
                      style={{ backgroundColor: 'white', top: '20%', left: '15%' }}
                    />
                    <div 
                      className="absolute w-4 h-4 rounded-full opacity-30"
                      style={{ backgroundColor: 'white', top: '60%', right: '20%' }}
                    />
                    <div 
                      className="absolute w-8 h-8 rounded-full opacity-15"
                      style={{ backgroundColor: 'white', bottom: '20%', left: '25%' }}
                    />
                  </div>
                ...
                <div className="relative h-3 w-full">
                  <svg width="376" height="12" viewBox="0 0 376 12" className="absolute top-0 w-full h-full" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
                ...
                <div className="bg-white flex-1 w-full relative flex flex-col justify-center px-5 py-2">
                  <p className="font-display text-sm font-black leading-none text-gray-900 text-center mb-1">
                    {flavor.title.replace(/\s*-\s*\d+mg.*$/, "")}
                  </p>
                  
                  <p className="text-xs leading-tight text-gray-700 text-center mb-2">
                  ...
                  <div className="flex items-center justify-center gap-3">
                    ...
                    <button className="px-3 text-xs h-6 border-none rounded-[50px] bg-gray-100 text-[#0B3835] hover:bg-[#0B3835] hover:text-white focus:bg-[#0B3835] focus:text-white active:bg-[#0B3835] active:text-white flex items-center justify-center relative box-border font-medium whitespace-nowrap transition-all duration-150">
                      + Add 12 Pack
                    </button>
                  </div>
                </div>
              ...
              {/* Default Card Content - Always visible, hidden on desktop hover */}
              <div className="relative w-full px-3 group-hover:lg:opacity-0 transition-opacity duration-300">
                <div className="relative m-auto flex h-auto w-4/6 flex-col items-center justify-center pt-7 mb-3 md:mb-5">
              ...
              {/* Text Container - Always visible, hidden on desktop hover */}
              <div className="row-span-1 row-start-2 h-full w-full group-hover:lg:opacity-0 transition-opacity duration-300" style={{ padding: '0px' }}>
                <div className="relative flex h-full w-full flex-col px-3 text-center">
                  <p className="pt-3 font-display text-sm font-black leading-none text-gray-900 md:pt-0 md:text-base">
                    {flavor.title.replace(/\s*-\s*\d+mg.*$/, "")}
                  </p>
                  
                  {/* Desktop rating - positioned at bottom */}
                  <div className="pt-[15px] hidden lg:block absolute bottom-[57px] left-1/2 -translate-x-1/2">
                    <div className="flex items-center text-gray-800">
                      <span className="text-sm">★★★★</span>
                      <span className="text-sm text-gray-400">☆</span>
                    </div>
                  ...
                  {/* Mobile content */}
                  <p className="my-2 text-xs leading-normal md:text-sm lg:hidden">
                    {flavor.shortDescription || flavor.description || "A boldly refreshing collision of flavors."}
                  </p>
                  
                  <div className="mt-auto flex flex-col items-center justify-between gap-y-3 pb-5 lg:hidden">
