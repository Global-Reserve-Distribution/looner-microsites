                ...
                {isHovered ? (
                  <>
                    ...
                    <div className="relative">
                      {lifestyleImage ? (
                        ...
                        >
                          <span className="text-white font-bold">LOONER</span>
                        </div>
                      )}
                    ...
                    <div className="px-4 py-4 bg-white">
                      ...
                      <p className="text-sm text-gray-600 line-clamp-2">
                        {flavor.description || "Premium cannabis-infused beverage"}
                      </p>
                  ...
                  <div className="flex flex-col items-center p-4">
                    {canImage ? (
                      ...
                      <div 
                        className="w-20 h-32 rounded-lg flex items-center justify-center"
                        style={{ backgroundColor: primary }}
                      >
