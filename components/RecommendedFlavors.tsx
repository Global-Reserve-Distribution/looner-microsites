          ...
          return (
            ...
            >
              ...
              <div className="relative w-full px-3 transition-all duration-300 ease-linear">
                ...
                <div className="absolute bottom-5 left-0 h-full w-full hidden lg:block">
                  <div 
                    className="absolute top-0 h-full w-full transition-all duration-300 group-hover:lg:top-3/4"
                    style={{ backgroundColor: secondary }}
                  >
                    <span className="relative -top-[13.5px] block w-full">
                      <svg width="376" height="12" viewBox="0 0 376 12" className="relative top-[2px] block w-full" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
